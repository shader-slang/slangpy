...
class WangHashArgMarshall(Marshall):
    ...
    def __init__(self, layout: SlangProgramLayout, dims: int):
        ...
        # Wang hash arg is always a vector, but size is defined by the call
    ...
    def resolve_dimensionality(self, context: BindContext, binding: BoundVariable, vector_target_type: SlangType):
        # Wang hash arg is a vector (dimensionality = 1), so subtract target type dimensionality from 1
