    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            # This works for both regular and fused functions
            ...
            # Update build_info with the specialized function (important for fused functions with generics)
            build_info.function = resolve_result.function
