...
R"doc(Optional backend compilation selector, e.g. sm_6_6, spirv_1_6, or
...
compiler assumptions, not verified output version ceilings.)doc";
...
R"doc(Origin of each forwarded input: device, explicit, override, profile,
or baseline.)doc";
...
static const char *__doc_sgl_SlangTargetInfo_profile =
R"doc(Native profile passed to Slang, if any. None for CUDA, including
explicit CUDA selectors.)doc";
...
static const char *__doc_sgl_SlangTargetInfo_requested_profile =
R"doc(Compilation selector explicitly requested by the caller, including
CUDA shorthand.)doc";
