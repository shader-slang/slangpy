...
profile. Cannot be combined with shader_model.)doc";
...
R"doc(Origin of each forwarded input: device, explicit, override, baseline,
or legacy.)doc";
...
static const char *__doc_sgl_SlangTargetInfo_legacy = R"doc(Whether this session uses the transitional legacy shader-model policy.)doc";
...
static const char *__doc_sgl_uses_compiler_target_options =
R"doc(Whether the caller selected the new capability-based policy during
migration.)doc";
