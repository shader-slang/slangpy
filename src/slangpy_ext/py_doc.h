...
static const char *__doc_sgl_Device_persistent_cache = R"doc()doc";
...
static const char *__doc_sgl_PersistentCache_expect_entry =
R"doc(Require future cache reads for this key to match validated code;
mismatches become misses.)doc";
...
static const char *__doc_sgl_PersistentCache_m_expected_entries = R"doc()doc";

static const char *__doc_sgl_PersistentCache_m_expected_entries_mutex = R"doc()doc";
...
static const char *__doc_sgl_SlangCompilerOptions_capabilities =
R"doc(Capability inputs replacing device defaults. None uses detected
inputs; an empty list does not. Inputs are assumptions, not an
absolute capability ceiling.)doc";

static const char *__doc_sgl_SlangCompilerOptions_capability_overrides =
R"doc(Adds (true) or removes (false) capability inputs, without subtracting
implied/profile requirements.)doc";
...
R"doc(Optional Slang profile. None selects an automatic compatibility
profile.)doc";
...
static const char *__doc_sgl_SlangSessionData_target_info = R"doc(Target selection associated with this successfully built session.)doc";
...
static const char *__doc_sgl_SlangSession_target_info = R"doc(Return a snapshot of this session's resolved compiler target.)doc";
...
static const char *__doc_sgl_SlangTargetInfo =
R"doc(Snapshot of target selection. Capabilities are forwarded inputs, not
Slang's full implication closure.)doc";

static const char *__doc_sgl_SlangTargetInfo_capabilities = R"doc(Canonical inputs actually forwarded to Slang.)doc";

static const char *__doc_sgl_SlangTargetInfo_capability_origins =
R"doc(Origin of each forwarded input: device, explicit, override, or
baseline.)doc";

static const char *__doc_sgl_SlangTargetInfo_generated_downstream_args =
R"doc(Arguments generated by SlangPy (excludes arguments generated
internally by Slang).)doc";

static const char *__doc_sgl_SlangTargetInfo_ignored_capabilities = R"doc(Detected names not recognized by the loaded compiler.)doc";

static const char *__doc_sgl_SlangTargetInfo_input_capabilities = R"doc(Unmodified base inputs, before overrides and reconciliation.)doc";

static const char *__doc_sgl_SlangTargetInfo_notes = R"doc(Compatibility decisions and limits of validation.)doc";

static const char *__doc_sgl_SlangTargetInfo_profile = R"doc(Profile passed to Slang, if any.)doc";

static const char *__doc_sgl_SlangTargetInfo_profile_automatic = R"doc(Whether the profile was selected automatically.)doc";

static const char *__doc_sgl_SlangTargetInfo_removed_capabilities = R"doc(Inputs removed by overrides or profile reconciliation, with reasons.)doc";

static const char *__doc_sgl_SlangTargetInfo_requested_profile = R"doc(Profile explicitly requested by the caller.)doc";

static const char *__doc_sgl_SlangTargetInfo_session_digest =
R"doc(Digest of the resolved Slang session descriptor, before cache search
paths are added.)doc";

static const char *__doc_sgl_SlangTargetInfo_target = R"doc(Output format selected by the device backend.)doc";
...
static const char *__doc_sgl_validate_compiler_target_args =
R"doc(Reject downstream flags that would independently override the resolved
target.)doc";

static const char *__doc_sgl_validate_cuda_program =
R"doc(Validate explicit CUDA architecture requests against generated entry-
point PTX before RHI compilation.)doc";
