...
) const
{
    ...
    // On CUDA (the only backend using this C++ fast path), _element_byte_stride is static const in shader.
    // On Metal, PyTorch tensors go through the Python path which adds _element_byte_stride to calldata.
    SGL_CHECK(
