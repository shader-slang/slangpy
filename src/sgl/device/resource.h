...
public:
    ...
    DescriptorHandle descriptor_handle_ro(Format format = Format::undefined, BufferRange range = {}) const;
    /// Get bindless descriptor handle for read-write access.
    DescriptorHandle descriptor_handle_rw(Format format = Format::undefined, BufferRange range = {}) const;
