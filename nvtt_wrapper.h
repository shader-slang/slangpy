...
typedef enum {
    ...
    NVTT_ChannelOrder_MaxEnum = 0x7FFFFFFF ///< Forces NvttChannelOrder to be a 32-bit enum; not valid to pass to
                                           ///< functions.
} NvttChannelOrder;
...
/// See nvtt::Severity.
typedef enum { NVTT_Severity_Info, NVTT_Severity_Warning, NVTT_Severity_Error, NVTT_Severity_Count } NvttSeverity;
...
typedef void (*nvttBeginImageHandler)(
    int size,
    int width,
    int height,
    int depth,
    int face,
    int miplevel
);                                                                    ///< See nvtt::OutputHandler::beginImage()
...
typedef void (*nvttMessageCallback)(
    NvttSeverity severity,
    NvttError error,
    const char* message,
    const void* userData
); ///< See nvtt::MessageCallback.
...
NVTT_API NvttCPUInputBuffer* nvttCreateCPUInputBuffer(
    const NvttRefImage* images,
    NvttValueType value_type,
    int numImages,
    int tile_w,
    int tile_h,
    float WeightR,
...
NVTT_API NvttGPUInputBuffer* nvttCreateGPUInputBuffer(
    const NvttRefImage* images,
    NvttValueType value_type,
    int numImages,
    int tile_w,
...
NVTT_API void nvttEncodeBC1CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean fast_mode,
    void* output,
    NvttBoolean useGpu,
    NvttBoolean to_device_mem,
    NvttTimingContext* tc
);
NVTT_API void nvttEncodeBC1GPU(
    const NvttGPUInputBuffer* input,
    NvttBoolean fast_mode,
    void* output,
    NvttBoolean to_device_mem,
    NvttTimingContext* tc
);
NVTT_API void nvttEncodeBC1ACPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean fast_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC1AGPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC2CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean fast_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC2GPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC3CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean fast_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC3GPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC3NCPU(const NvttCPUInputBuffer* input, int qualityLevel, void* output, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC3RGBMCPU(
    const NvttCPUInputBuffer* input,
    void* output,
    NvttBoolean useGpu,
    NvttBoolean to_device_mem,
...
NVTT_API void nvttEncodeBC4CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    void* output,
    NvttBoolean useGpu,
    NvttBoolean to_device_mem,
    NvttTimingContext* tc
...
NVTT_API void
nvttEncodeBC4GPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC4SCPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC4SGPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeATI2CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeATI2GPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC5CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC5GPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC5SCPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    void* output,
    NvttBoolean useGpu,
...
NVTT_API void
nvttEncodeBC5SGPU(const NvttGPUInputBuffer* input, void* output, NvttBoolean to_device_mem, NvttTimingContext* tc);
NVTT_API void nvttEncodeBC6HCPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    NvttBoolean is_signed,
    void* output,
    NvttBoolean useGpu,
    NvttBoolean to_device_mem,
    NvttTimingContext* tc
);
NVTT_API void nvttEncodeBC6HGPU(
    const NvttGPUInputBuffer* input,
    NvttBoolean is_signed,
    void* output,
    NvttBoolean to_device_mem,
...
NVTT_API void nvttEncodeBC7CPU(
    const NvttCPUInputBuffer* input,
    NvttBoolean slow_mode,
    NvttBoolean imageHasAlpha,
    void* output,
    NvttBoolean useGpu,
    NvttBoolean to_device_mem,
    NvttTimingContext* tc
);
NVTT_API void nvttEncodeBC7GPU(
    const NvttGPUInputBuffer* input,
    NvttBoolean imageHasAlpha,
    void* output,
    NvttBoolean to_device_mem,
...
NVTT_API void nvttEncodeASTCCPU(
    const NvttCPUInputBuffer* input,
    int qualityLevel,
    NvttBoolean imageHasAlpha,
    void* output,
...
NVTT_API void nvttEncodeASTCGPU(
    const NvttGPUInputBuffer* input,
    int qualityLevel,
    NvttBoolean imageHasAlpha,
    void* output,
...
NVTT_API void nvttSetOutputOptionsOutputHandler(
...
NVTT_API NvttBoolean nvttContextOutputHeader(
    const NvttContext* context,
    const NvttSurface* img,
    int mipmapCount,
    const NvttCompressionOptions* compressionOptions,
    const NvttOutputOptions* outputOptions
);
NVTT_API NvttBoolean nvttContextCompress(
    const NvttContext* context,
    const NvttSurface* img,
    int face,
    int mipmap,
...
NVTT_API int nvttContextEstimateSize(
    const NvttContext* context,
    const NvttSurface* img,
    int mipmapCount,
    const NvttCompressionOptions* compressionOptions
...
NVTT_API void
nvttContextQuantize(const NvttContext* context, NvttSurface* tex, const NvttCompressionOptions* compressionOptions);
NVTT_API NvttBoolean nvttContextOutputHeaderCube(
    const NvttContext* context,
    const NvttCubeSurface* img,
    int mipmapCount,
    const NvttCompressionOptions* compressionOptions,
    const NvttOutputOptions* outputOptions
);
NVTT_API NvttBoolean nvttContextCompressCube(
    const NvttContext* context,
    const NvttCubeSurface* img,
    int mipmap,
    const NvttCompressionOptions* compressionOptions,
...
NVTT_API int nvttContextEstimateSizeCube(
    const NvttContext* context,
    const NvttCubeSurface* img,
    int mipmapCount,
    const NvttCompressionOptions* compressionOptions
);
NVTT_API NvttBoolean nvttContextOutputHeaderData(
    const NvttContext* context,
    ...
    int d,
    int mipmapCount,
    NvttBoolean isNormalMap,
    const NvttCompressionOptions* compressionOptions,
    const NvttOutputOptions* outputOptions
);
NVTT_API NvttBoolean nvttContextCompressData(
    const NvttContext* context,
    int w,
    int h,
    int d,
...
NVTT_API int nvttContextEstimateSizeData(
    const NvttContext* context,
    int w,
    int h,
    int d,
...
NVTT_API NvttBoolean nvttContextCompressBatch(
    const NvttContext* context,
    const NvttBatchList* lst,
    const NvttCompressionOptions* compressionOptions
);
...
NVTT_API void nvttSurfaceHistogram(
    const NvttSurface* surface,
    int channel,
    float rangeMin,
    float rangeMax,
    int binCount,
...
NVTT_API void nvttSurfaceRange(
    const NvttSurface* surface,
    int channel,
    float* rangeMin,
    float* rangeMax,
...
NVTT_API NvttBoolean nvttSurfaceLoad(
    NvttSurface* surface,
    const char* filename,
    NvttBoolean* hasAlpha,
    NvttBoolean expectSigned,
    NvttTimingContext* tc
);
NVTT_API NvttBoolean nvttSurfaceLoadFromMemory(
    NvttSurface* surface,
    const void* data,
...
NVTT_API NvttBoolean nvttSurfaceSave(
    const NvttSurface* surface,
    const char* fileName,
    NvttBoolean hasAlpha,
    NvttBoolean hdr,
...
NVTT_API NvttBoolean nvttSurfaceSetImageData(
    NvttSurface* surface,
    ...
    int d,
    const void* data,
    NvttBoolean unsignedToSigned,
    NvttTimingContext* tc
);
NVTT_API NvttBoolean nvttSurfaceSetImageRGBA(
    NvttSurface* surface,
    NvttInputFormat format,
    int w,
    int h,
...
nvttSurfaceSetImage2D(NvttSurface* surface, NvttFormat format, int w, int h, const void* data, NvttTimingContext* tc);
NVTT_API NvttBoolean nvttSurfaceSetImage3D(
    NvttSurface* surface,
    NvttFormat format,
    int w,
    int h,
...
NVTT_API void nvttSurfaceResize(
    NvttSurface* surface,
    int w,
    int h,
    int d,
    NvttResizeFilter filter,
    float filterWidth,
    const float* params,
    NvttTimingContext* tc
);
NVTT_API void nvttSurfaceResizeMax(
    NvttSurface* surface,
    int maxExtent,
    NvttRoundMode mode,
    NvttResizeFilter filter,
...
NVTT_API void nvttSurfaceResizeMaxParams(
    NvttSurface* surface,
    int maxExtent,
    NvttRoundMode mode,
    NvttResizeFilter filter,
...
NVTT_API void nvttSurfaceResizeMakeSquare(
    NvttSurface* surface,
    int maxExtent,
    NvttRoundMode mode,
    NvttResizeFilter filter,
...
NVTT_API NvttBoolean nvttSurfaceBuildNextMipmap(
    NvttSurface* surface,
...
NVTT_API NvttBoolean
nvttSurfaceBuildNextMipmapDefaults(NvttSurface* surface, NvttMipmapFilter filter, int min_size, NvttTimingContext* tc);
NVTT_API NvttBoolean
nvttSurfaceBuildNextMipmapSolidColor(NvttSurface* surface, const float* const color_components, NvttTimingContext* tc);
...
NVTT_API void nvttSurfaceTransform(
    NvttSurface* surface,
    const float w0[4],
    const float w1[4],
    const float w2[4],
...
NVTT_API void
nvttSurfaceBlend(NvttSurface* surface, float r, float g, float b, float a, float t, NvttTimingContext* tc);
...
NVTT_API void nvttSurfaceToGreyScale(
    NvttSurface* surface,
    float redScale,
    float greenScale,
    float blueScale,
...
NVTT_API void nvttSurfaceScaleAlphaToCoverage(
    NvttSurface* surface,
    float coverage,
    float alphaRef,
    int alpha_channel,
...
NVTT_API void
nvttSurfaceConvolve(NvttSurface* surface, int channel, int kernelSize, float* kernelData, NvttTimingContext* tc);
...
NVTT_API void nvttSurfaceSetAtlasBorder(
    NvttSurface* surface,
    int w,
    int h,
    float r,
...
NVTT_API void
nvttSurfaceBinarize(NvttSurface* surface, int channel, float threshold, NvttBoolean dither, NvttTimingContext* tc);
NVTT_API void nvttSurfaceQuantize(
    NvttSurface* surface,
    int channel,
    int bits,
    NvttBoolean exactEndPoints,
    NvttBoolean dither,
    NvttTimingContext* tc
);
NVTT_API void
nvttSurfaceToNormalMap(NvttSurface* surface, float sm, float medium, float big, float large, NvttTimingContext* tc);
...
NVTT_API NvttSurface* nvttSurfaceCreateSubImage(
    const NvttSurface* surface,
    int x0,
    int x1,
    int y0,
...
NVTT_API NvttBoolean nvttSurfaceCopyChannel(
    NvttSurface* surface,
    const NvttSurface* srcImage,
    int srcChannel,
    int dstChannel,
    NvttTimingContext* tc
);
NVTT_API NvttBoolean nvttSurfaceAddChannel(
    NvttSurface* surface,
    const NvttSurface* srcImage,
    int srcChannel,
    int dstChannel,
...
NVTT_API NvttBoolean nvttSurfaceCopy(
    NvttSurface* surface,
    const NvttSurface* srcImage,
    int xsrc,
    int ysrc,
...
NVTT_API NvttSurface*
nvttSurfaceSetGetSurface(NvttSurfaceSet* surfaceSet, int faceId, int mipId, NvttBoolean expectSigned);
NVTT_API NvttBoolean nvttSurfaceSetLoadDDS(NvttSurfaceSet* surfaceSet, const char* fileName, NvttBoolean forcenormal);
NVTT_API NvttBoolean nvttSurfaceSetLoadDDSFromMemory(
    NvttSurfaceSet* surfaceSet,
    const void* data,
    unsigned long long sizeInBytes,
    NvttBoolean forcenormal
);
...
NVTT_API NvttBoolean nvttCubeSurfaceLoadFromMemory(
    NvttCubeSurface* cubeSurface,
    const void* data,
    unsigned long long sizeInBytes,
    int mipmap
);
...
NVTT_API void
nvttCubeSurfaceRange(const NvttCubeSurface* cubeSurface, int channel, float* minimum_ptr, float* maximum_ptr);
NVTT_API void nvttCubeSurfaceClamp(NvttCubeSurface* cubeSurface, int channel, float low, float high);
NVTT_API NvttCubeSurface*
nvttCubeSurfaceIrradianceFilter(const NvttCubeSurface* cubeSurface, int size, NvttEdgeFixup fixupMethod);
NVTT_API NvttCubeSurface* nvttCubeSurfaceCosinePowerFilter(
    const NvttCubeSurface* cubeSurface,
    int size,
    float cosinePower,
    NvttEdgeFixup fixupMethod
);
NVTT_API NvttCubeSurface*
nvttCubeSurfaceFastResample(const NvttCubeSurface* cubeSurface, int size, NvttEdgeFixup fixupMethod);
...
NVTT_API void nvttBatchListAppend(
    NvttBatchList* batchList,
    const NvttSurface* pImg,
    int face,
    int mipmap,
    const NvttOutputOptions* outputOptions
);
NVTT_API unsigned nvttBatchListGetSize(const NvttBatchList* batchList);
NVTT_API void nvttBatchListGetItem(
    const NvttBatchList* batchList,
    unsigned i,
    const NvttSurface** pImg,
    int* face,
    int* mipmap,
...
NVTT_API NvttSurface*
nvttDiff(const NvttSurface* reference, const NvttSurface* img, float scale, NvttTimingContext* tc);
NVTT_API float
nvttRmsToneMappedError(const NvttSurface* reference, const NvttSurface* img, float exposure, NvttTimingContext* tc);
NVTT_API NvttSurface* nvttHistogram(const NvttSurface* img, int width, int height, NvttTimingContext* tc);
NVTT_API NvttSurface* nvttHistogramRange(
    const NvttSurface* img,
    float minRange,
    float maxRange,
    int width,
...
NVTT_API void nvttGetTargetExtent(
    int* width,
    int* height,
    int* depth,
    int maxExtent,
    NvttRoundMode roundMode,
    NvttTextureType textureType,
    NvttTimingContext* tc
);
...
NVTT_API size_t nvttTimingContextGetRecordSafe(
    NvttTimingContext* timingContext,
    int i,
    char* outDescription,
