...
.. py:class:: slangpy.SlangCompilerOptions
    ...
    .. py:property:: capabilities
        ...
        Capability inputs replacing device defaults. None uses detected
        inputs; an empty list does not. Inputs are assumptions, not an
        absolute capability ceiling.

    .. py:property:: capability_overrides
        :type: dict[str, bool]

        Adds (true) or removes (false) capability inputs, without subtracting
        implied/profile requirements.
...
.. py:class:: slangpy.SlangSession
    ...
    .. py:property:: target_info
        :type: slangpy.SlangTargetInfo

        Return a snapshot of this session's resolved compiler target.
...
.. py:class:: slangpy.SlangTargetInfo

    Snapshot of target selection. Capabilities are forwarded inputs, not
    Slang's full implication closure.
    ...
    .. py:property:: ignored_capabilities
        :type: list[str]

        Detected names not recognized by the loaded compiler.

    .. py:property:: generated_downstream_args
        :type: list[str]

        Arguments generated by SlangPy (excludes arguments generated
        internally by Slang).

    .. py:property:: notes
        :type: list[str]

        Compatibility decisions and limits of validation.

    .. py:property:: session_digest
        :type: str

        Digest of the resolved Slang session descriptor, before cache search
        paths are added.
