...
The checked-in source below is exercised by ``samples/tests/examples/test_examples.py``.

First, let's define a simple Slang function to add two numbers together:

.. literalinclude:: ../../../samples/examples/first_function/example.slang
   :language: slang

Next, we'll create a Python script to initialize SlangPy, load the Slang module, and call the function:

.. literalinclude:: ../../../samples/examples/first_function/main_scalar.py
   :language: python
