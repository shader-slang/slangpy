...
class TestUserWhitelist:
    ...
    def test_no_approved_users_allows_all(self, clean_environment: None):
    ...
    def test_user_in_approved_list(self, clean_environment: None):
    ...
    def test_user_not_in_approved_list(self, clean_environment: None):
