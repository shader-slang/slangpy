...
DESCRIPTOR_CONVERT_TYPES = {
    ...
    "ClusterOperationBlasBuildParams": True,
    "ClusterOperationClasBuildParams": True,
    "ClusterOperationDesc": True,
    "ClusterOperationMoveParams": True,
    "ClusterOperationParams": True,
