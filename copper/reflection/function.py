...
from .base import Modifier, SlangType, VoidType, DifferentialPairType
...
class SlangFunc:
    ...
    def __repr__(self):
        ...
        return f'{mods}{self.return_type} {self.name}({", ".join(repr(p) for p in self.params)})'
